...
This project is available under the MIT license. See the [LICENSE](https://github.com/wataru-maeda/react-native-boilerplate/blob/main/LICENSE) file for more info.#   s o u n d i f y - n a t i v e  
 #   s o u n d i f y N a t i v e  
 